        ...
        return when (settings.configurationPack) {
            Imperium -> SuggestedIntelChannels(
                ...
                channels = listOf(
                    ...
                    IntelChannel("condisov.imperium", "Catch"),
                    IntelChannel("condisov.imperium", "Immensea"),
                    IntelChannel("condisov.imperium", "Impass"),
                    IntelChannel("condisov.imperium", "Tenerifis"),
